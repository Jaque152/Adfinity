...
export const dictionaries = {
  es: {
    ...
    store: {
      eyebrow: "/ servicios",
      heading: "Piezas creativas que enganchan a tu comunidad y llevan tu marca al siguiente nivel.",
      desc: "Impulsamos la voz de tu empresa combinando diseño inteligente, narrativa visual y estrategia digital, con planes que escalan al mismo ritmo que tu negocio.",
  ...
  en: {
    ...
    store: {
      eyebrow: "/ services",
      heading: "Creative assets that engage your community and take your brand to the next level.",
      desc: "We boost your company's voice by combining smart design, visual storytelling, and digital strategy, with plans that scale at the same pace as your business.",
